...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍɪʟʟɪᴇ' : process.env.ALL_CAPTION,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/FOecCE3.mp4' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/mF4rElO.mp4' : process.env.GIF_BYE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ᴍɪʟʟɪᴇ' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/euprrJo.jpeg' : process.env.ALL_IMG,
